        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="inactivateList.php">Inactivate List</a>
                    </li>
            ...
            <div id="infoUser">
                ...
                <label class="tittle">Username:</label> <br>
                <label class= "classLabel"><?php echo $_SESSION['user']?></label> <br>

                <label class="tittle">Email:</label> <br>
                <label class= "classLabel"><?php echo $_SESSION['email']?></label><br>
                
                <button type="button" class="btn btn-danger"  onclick="redirectLogin();">Log Out</button>
